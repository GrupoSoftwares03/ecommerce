              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/admin/categories/<?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/products" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Produtos</a>
